...
export FLIGHTS_IMAGE_TAG="$image_tag"

# Start deploy flights script
echo "Start deploy flights script (image tag: $FLIGHTS_IMAGE_TAG)."
...
for service in flights-api flights-ui; do
